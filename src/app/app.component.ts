...
export class AppComponent {
  text = `
    ...
    Paragraph #2 Paragraph #2 Paragraph #2 Paragraph #2 Paragraph #2 Paragraph #2 Paragraph #2 Paragraph #2 Paragraph #2 Paragraph #2
    Paragraph #3 Paragraph #3 Paragraph #3 Paragraph #3 Paragraph #3 Paragraph #3 Paragraph #3 Paragraph #3 Paragraph #3 Paragraph #3
    Paragraph #4 Paragraph #4 Paragraph #4 Paragraph #4 Paragraph #4 Paragraph #4 Paragraph #4 Paragraph #4 Paragraph #4 Paragraph #4
  `;
}
